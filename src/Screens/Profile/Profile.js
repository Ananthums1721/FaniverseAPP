...
const Profile = () => {
  ...
  const renderImageItem = ({ item }) => (
    <View style={{ width: "33%", height: "33%", padding: 0 }}>
      <ImageBackground
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        >
          ...
          <Text style={{ textAlign: "center", marginTop: 10, color: "black" }}>
            Sed arcu dolor ante et pellentesque. Cras eget ornare enim
            penatibus. Ultricies proin dapibus risus.
          </Text>
        </View>
        <View style={styles.tab}>
          <View style={{ width: getWidth(5.5), marginLeft: -2 }}>
            <TouchableOpacity style={styles.fanouterview}>
              <ImageBackground
                source={images.ViratProfile}
                resizeMode="cover"
                style={styles.fanBackground}
              >
                {/* <Image style={styles.logo} source={images.PlusCircle} /> */}
              </ImageBackground>
            </TouchableOpacity>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("FanWall")}
          ...
          >
            ...
            >
              <Text style={{ color: "white" }}>{"Fan Wall >>"}</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
        {/* Tabs */}
      ...
      >
        ...
        >
          ...
          >
            <Image
              style={{
                width: selectedTab === 0 ? 35 : 30,
                height: selectedTab === 0 ? 35 : 25,
              }}
              source={selectedTab === 0 ? images.Image : images.GrayImage}
            />
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          >
            <Image
              ...
              source={selectedTab === 1 ? images.WhiteReel : images.GrayReel}
            />
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          >
            <Image
              style={{ width: 35, height: 35 }}
              source={selectedTab === 2 ? images.WhiteTropy : images.Tropy}
            />
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => handleTabPress(3)}
          style={[styles.bottumtab, selectedTab === 3 && styles.activeTab]}
        >
          {/* <Text style={selectedTab === 1 ? styles.activeTabText : styles.tabText}>Items</Text> */}
          <LinearGradient
            colors={
          ...
          >
            <Image
              style={{ width: 35, height: 35 }}
              source={selectedTab === 3 ? images.whiteBasket : images.Basket}
            />
          </LinearGradient>
        </TouchableOpacity>
      </TouchableOpacity>
