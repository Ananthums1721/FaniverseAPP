...
const PopoverMenu = ({ pop, icon_1, icon_2, icon_3, icon_4, popIn, popOut, }) => {
    ...
    <>
      ...
      {modalTrue === true ? (
        <View style={styles.clickableGradient1}>
          ...
          <TouchableOpacity style={{ position: 'absolute', bottom: 20, left: 25 }}>
            <ImageSVG />
            <Text style={{ color: 'white' }}>Post</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ position: 'absolute', bottom: 71, left: 73 }}>
            <FilimSVG />
            <Text style={{ color: 'white' }}>Flare</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ position: 'absolute', bottom: 71, left: 148 }}>
            <LiveSVG />
            <Text style={{ color: 'white' }}>Live</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ position: 'absolute', bottom: 20, left: 200 }}>
            <StorySVG />
      ...
      <TouchableOpacity style={styles.clickableGradient} onPress={() => bttomModal()}>
        <FaniverseIconSVG />
      </TouchableOpacity>
    </>
  );
